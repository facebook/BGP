...
class AdjRib : boost::noncopyable,
 ...
 public:
   ...
   * update-group. This is a group diagnostic; peer APIs use per-peer counts.
   */
   ...
   * This is a group diagnostic; peer APIs use per-peer counts.
   */
